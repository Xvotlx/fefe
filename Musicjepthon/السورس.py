...
@Client.on_message(filters.command(["ب9عنك"], prefixes=f"{HNDLR}"))
...
@Client.on_message(filters.command(["الاوابمر"], prefixes=f"{HNDLR}"))
async def help(client, m: Message):
    await m.delete()
    JEPM = f"""
👋 اهلا {m.from_user.mention}!
اوامر سورس العمدة [ {OWNER_NAME} ](t.me/{CHANNEL})
——————×—————
